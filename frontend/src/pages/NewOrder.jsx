...
const NewOrder = () => {
  ...
  const [formData, setFormData] = useState({
    tableNumber: '',
    items: [{ name: '', quantity: 1, notes: '', category: 'kitchen' }]
  });
  ...
  const addItem = () => {
    setFormData({
      ...formData,
      items: [...formData.items, { name: '', quantity: 1, notes: '', category: 'kitchen' }]
    });
  };
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="mb-6">
            ...
            <button
              type="button"
              onClick={addItem}
              className="flex items-center gap-1 text-rose-600 hover:text-rose-800 mt-2"
            >
              <Plus size={16} />
              Add Another Item
            </button>
