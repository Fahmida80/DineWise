...
const ingredients = [
  { name: 'Romaine Lettuce', stock: 100, unit: 'head', threshold: 2 },
  { name: 'Caesar Dressing', stock: 200, unit: 'g', threshold: 50 },
  { name: 'Croutons', stock: 150, unit: 'g', threshold: 30 },
  ...
  { name: 'Potatoes', stock: 300, unit: 'g', threshold: 200 },
  ...
  { name: 'Fish Fillets', stock: 100, unit: 'g', threshold: 150 },
  { name: 'Pizza Dough', stock: 100, unit: 'g', threshold: 200 },
...
// ... keep all your imports and ingredients array unchanged ...

// List of menu items with AI TAGS added for EVERY item
const menuItems = [
  {
    name: 'Caesar Salad',
    ...
    price: 300,
    category: 'kitchen',
    tags: ['lunch', 'light-meal', 'hot-weather'],
    ingredients: [
  ...
  },
  {
    ...
    price: 320,
    category: 'kitchen',
    tags: ['lunch', 'dinner', 'comfort-food', 'cold-weather'],
    ingredients: [
  ...
  },
  {
    ...
    price: 780,
    category: 'kitchen',
    tags: ['dinner', 'comfort-food', 'popular'],
    ingredients: [
  ...
  },
  {
    ...
    price: 485,
    category: 'kitchen',
    tags: ['lunch', 'dinner', 'comfort-food'],
    ingredients: [
  ...
  },
  {
    ...
    price: 270,
    category: 'kitchen',
    tags: ['lunch', 'dinner', 'light-meal', 'hot-weather'],
    ingredients: [
